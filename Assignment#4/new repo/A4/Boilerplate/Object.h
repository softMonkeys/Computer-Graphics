...
public:
	Object();
	Object(glm::vec3 col, glm::vec3 norm, glm::vec3 c_r, glm::vec3 c_p, float p, float r);
	virtual ~Object();
...
public:
	Sphere(glm::vec3 c, float r, glm::vec3 col, glm::vec3 c_r, glm::vec3 c_p, float p, float ref);
	virtual ~Sphere();
...
public:
	Triangle(glm::vec3 a, glm::vec3 b, glm::vec3 c, glm::vec3 col, glm::vec3 c_r, glm::vec3 c_p, float p, float ref);
	virtual ~Triangle();
...
public:
	Plane(glm::vec3 n, glm::vec3 poi, glm::vec3 col, glm::vec3 c_r, glm::vec3 c_p, float p, float ref);
	virtual ~Plane();
