...
RenderingEngine::RenderingEngine() {
	shaderProgram = ShaderTools::InitializeShaders();	// GLSL - shadere 1. Things got to GPU  2. Vertex Shader- per vertex  3. OPtional Geometry shader  4. Fragment shader - per pixel
	if (shaderProgram == 0) {
